...
> [!IMPORTANT]
> Currently PAL2 is basically feature complete on Windows, and most parts work on x11 and macos. There might be some APIs that don't work on all platforms currently.
